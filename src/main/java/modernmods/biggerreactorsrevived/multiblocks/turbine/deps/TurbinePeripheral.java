package modernmods.biggerreactorsrevived.multiblocks.turbine.deps;
...
import modernmods.biggerreactorsrevived.multiblocks.turbine.state.VentState;
...
public class TurbinePeripheral implements IPeripheral {
    ...
    @Nonnull
    private final LambdaExceptionUtils.Supplier_WithExceptions<TurbineMultiblockController, LuaException> controllerSupplier;
    ...
    public static class Battery {
        ...
        public Battery(LambdaExceptionUtils.Supplier_WithExceptions<TurbineMultiblockController, LuaException> controllerSupplier) {
    ...
    public static class Rotor {
        ...
        public Rotor(LambdaExceptionUtils.Supplier_WithExceptions<TurbineMultiblockController, LuaException> controllerSupplier) {
            this.controllerSupplier = controllerSupplier;
        }
    ...
    public static class FluidTank {
        ...
        public FluidTank(LambdaExceptionUtils.Supplier_WithExceptions<TurbineMultiblockController, LuaException> controllerSupplier) {
            this.controllerSupplier = controllerSupplier;
        ...
        public static class TankFluid {
            final LambdaExceptionUtils.Supplier_WithExceptions<TurbineMultiblockController, LuaException> controllerSupplier;
            final int tankNum;

            public TankFluid(LambdaExceptionUtils.Supplier_WithExceptions<TurbineMultiblockController, LuaException> controllerSupplier, int tankNum) {
                this.controllerSupplier = controllerSupplier;
    ...
    public static class Vent {
        ...
        public Vent(LambdaExceptionUtils.Supplier_WithExceptions<TurbineMultiblockController, LuaException> controllerSupplier) {
            this.controllerSupplier = controllerSupplier;
        }
