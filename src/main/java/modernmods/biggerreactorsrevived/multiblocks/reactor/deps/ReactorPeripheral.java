package modernmods.biggerreactorsrevived.multiblocks.reactor.deps;
...
public class ReactorPeripheral implements IPeripheral {
    ...
    @Nonnull
    private final LambdaExceptionUtils.Supplier_WithExceptions<ReactorMultiblockController, LuaException> controllerSupplier;
    @Nonnull
    private final LambdaExceptionUtils.Supplier_WithExceptions<IReactorSimulation, LuaException> simulationSupplier;
    ...
    public static class Battery {
        ...
        @Nonnull
        private final LambdaExceptionUtils.Supplier_WithExceptions<IReactorSimulation.IBattery, LuaException> batterySupplier;
        
        public Battery(@Nonnull LambdaExceptionUtils.Supplier_WithExceptions<IReactorSimulation, LuaException> simulationSupplier) {
    ...
    public static class CoolantTank {
        ...
        @Nonnull
        private final LambdaExceptionUtils.Supplier_WithExceptions<IReactorSimulation.ICoolantTank, LuaException> coolantTankSupplier;
        @Nonnull
        private final LambdaExceptionUtils.Supplier_WithExceptions<ReactorTransitionTank, LuaException> transitionTankSupplier;
        
        public CoolantTank(@Nonnull LambdaExceptionUtils.Supplier_WithExceptions<ReactorMultiblockController, LuaException> controllerSupplier, @Nonnull LambdaExceptionUtils.Supplier_WithExceptions<IReactorSimulation, LuaException> simulationSupplier) {
...
//        }
    ...
    public static class FuelTank {
        ...
        public FuelTank(@Nonnull LambdaExceptionUtils.Supplier_WithExceptions<ReactorMultiblockController, LuaException> controllerSupplier, @Nonnull LambdaExceptionUtils.Supplier_WithExceptions<IReactorSimulation, LuaException> simulationSupplier) {
...
//        }
    ...
    public static class ControlRod {
        ...
        public ControlRod(LambdaExceptionUtils.Supplier_WithExceptions<ReactorMultiblockController, LuaException> controllerSupplier, int index) {
            this.controllerSupplier = controllerSupplier;
            this.index = index;
        }
